...
<div class="wrapper col3">
  <div id="container">
    <div id="content">
        <div class="column2">
            <h2>{{ $single->nama }}</h2>  
            <h3>Tanggal Lahir : {{ date('d/m/Y', strtotime($single->tgl_lahir)) }}</h3> <br>    
            <h3>Tempat Lahir : {{ $single->tempat_lahir }}</h3> <br>
            <h3>Alamat : {{ $single->alamat }}</h3> <br>
            <h3>Agama : {{ $single->agama}}</h3> <br>
            <h3>Jabatan : {{ $single->jabatan->jabatan }}</h3> <br>
