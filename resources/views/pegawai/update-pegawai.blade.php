                ...
                <div class="row">
                  <div class="col-12">
                    <div class="card card-default">
                      ...
                      <div class="card-body">
                        <form action="{{ url('perubahan-pegawai/' .$pegawai->id) }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <input type="date" name="tgl_lahir" class="form-control" placeholder="Tanggal Lahir" value="{{$pegawai->tgl_lahir}}">
                            </div>
                            <div class="form-group">
